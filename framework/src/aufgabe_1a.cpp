...
main(int, char* argv[]) {
    ...
    // vertex data, edges for four corners of the triangle
    float vertices[] = {
        -0.5f, -0.5f, 0.0f,
         0.5f, -0.5f, 0.0f,
         0.5f,  0.5f, 0.0f,
    ...
    while (glfwWindowShouldClose(window) == false) {
        ...
        glBindVertexArray(VAO);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*) 0); // draw two triangles with indices given by indices[]
