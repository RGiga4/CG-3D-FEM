...
int main(int, char* argv[]) {
	...
	Body.myloadScene("C:\\Users\\roman\\Desktop\\framework\\blender\\Pudding\\thepudding.obj", true, glm::vec4(1.0f, 0.5f, 0.2f, 1.0f));
	...
	while ((glfwWindowShouldClose(window) == false) && true) {
		...
		for (int i = 0; i < 3 * Body.n_Vet - Body.n_fix; i++) {
